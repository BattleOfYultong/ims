...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2024 at 09:22 PM
...
(1, 5, 'Andriod Phone', 'active'),
(2, 2, 'Peanut Butter', 'active'),
(3, 5, 'Plate', 'active'),
(4, 4, 'Gym Weights', 'active'),
(5, 1, 'Frozen Meat', 'active'),
(6, 1, 'Can foods', 'active'),
(7, 5, 'Smart TV', 'active'),
(8, 3, 'Iphone', 'active'),
(9, 3, 'Jewelry', 'active');
...
(1, 'Perishable Items', 'active'),
(2, 'Non-Perishable Item', 'active'),
(3, 'High Value Items', 'active'),
(4, 'Bulk Items', 'active'),
(5, 'Fragile Items', 'active');
...
(1, 'Mark tahimik lang', 'Caloocan', 2147483647, 25000.00),
(2, 'Marcos', 'Kongress', 2147483647, 35000.00),
(3, 'Shesh boy', 'Quezon City', 2147483647, 5000.00);
...
(1, 'James', '09645987123', 'Metro Manila', 'active'),
(2, 'George', '094568791252', 'Bulacan', 'active'),
(3, 'Alex', '09789897879', 'Caloocan', 'active');
